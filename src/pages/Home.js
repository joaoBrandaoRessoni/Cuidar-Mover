    ...
    useEffect(() => {
        ...
        const getProfile = async () => {
            try {
                ...
                const cachedProfile = await getItemFromAsyncStorage("profile");
                if (cachedProfile) {
                ...
                if (response?.data?.profile?.photoUrl) {
                    try {
                        ...
                        console.log("Erro ao buscar foto (ignorado):", fotoError?.response?.status);
                ...
                await AsyncStorage.setItem("profile", JSON.stringify(searchProfile));
